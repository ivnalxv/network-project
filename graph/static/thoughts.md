...
1. Сделать постройку CDG графа в новом формате
2. Сделать поиск циклов в CDG графе (игнорировать циклы по 1D-кольцам)
   - циклы выводились сразу в двух форматах
   - в графе CDG
   - соответствующий ему цикл в графе сети
3. Тестирование построения CDG
   - поддержать несколько измерений (сейчас есть костыли)
   - генерацию тора


### Вопросы
- Направленные ли ребра у CDG графа?
- Что делать в ситуации
  (цикл из-за направления терминала)
Node(id_=8, name='edge_8', tags=['connect_one:5', 'connect_two:6', 'direction_one_to_two:+K', 'direction_two_to_one:-K'])
Node(id_=11, name='edge_11', tags=['connect_one:3', 'connect_two:6', 'direction_one_to_two:+Z', 'direction_two_to_one:+K'])
Node(id_=8, name='edge_8', tags=['connect_one:5', 'connect_two:6', 'direction_one_to_two:+K', 'direction_two_to_one:-K'])
- Есть ли у графа CDG мультиреберность?
  - То есть, если между двумя ребрами настоящего графа есть несколько способов сделать поворот - считаем это одним ребром?
  - Как правильно строить ребро для терминалов?
  - Просто всегда делаем добавляем ребро в CDG если одна из нод это терминал?
